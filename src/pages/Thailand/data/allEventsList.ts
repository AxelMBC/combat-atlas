// TODO: Replace with API data once backend endpoint is available
...
export const mainEventFights: MainEvent[] = [
  {
    ...
    idYt: "Ve4Le7AC1EY",
    startTime: "14",
    tags: ["Muay Thai Legends", "Thai Martial Arts", "Clinch Mastery"],
    fighterId: "1",
    fighterBlue: "Namsaknoi Yudthagarngamtorn",
    fighterRed: "Suphachai Saepong",
  },
  {
    id: 1,
    ...
    idYt: "zgaVBmY9NhI",
    startTime: "14",
    tags: ["Muay Thai Legends", "Epic Draw", "Clinch Mastery"],
    fighterId: "4",
    fighterBlue: "Namsaknoi Yudthagarngamtorn",
    fighterRed: "Attachai Fairtex",
  },
  {
    id: 2,
    ...
    idYt: "2q1SeWQ8J3w",
    startTime: "502",
    tags: ["Muay Thai Legends", "Wai Kru Mastery", "Decision Victory"],
    fighterId: "4",
    fighterBlue: "Namsaknoi Yudthagarngamtorn",
    fighterRed: "Rambo-Jiu",
  },
  {
    id: 3,
    ...
    idYt: "_ly7qiJAr_M",
    startTime: "62",
    tags: ["Muay Thai Legend", "Technical Mastery", "Lumpini Stadium"],
    fighterId: "5",
    fighterBlue: "Samart Payakaroon",
    fighterRed: "Samransak Muangsurin",
  },
];
