...
const en: Record<TranslationKey, string> = {
  ...
  'eventForm.help.youtubeIdFormat': '11-character video ID (e.g. dQw4w9WgXcQ)',
  'eventForm.help.mainFighterIdInfo': 'Internal ID of the featured fighter in this match',
  ...
  'validation.youtubeIdInvalid': 'YouTube ID must be exactly 11 characters.',
  'validation.startTimeInvalid': 'Start time must be ≥ 0.',
  'validation.titleLength': 'Title must be between {min} and {max} characters.',
  'validation.descriptionLength': 'Description must be between {min} and {max} characters.',
