const es = {
  ...
  "error.noFighterEvent":
    "No se encontró un evento principal para el peleador seleccionado.",
  ...
  "eventForm.help.mainFighterIdInfo":
    "ID interno del peleador destacado en esta pelea",
  ...
  "validation.youtubeIdInvalid":
    "El ID de YouTube debe tener exactamente 11 caracteres.",
  "validation.startTimeInvalid": "El tiempo de inicio debe ser ≥ 0.",
  "validation.titleLength":
    "El título debe tener entre {min} y {max} caracteres.",
  "validation.descriptionLength":
    "La descripción debe tener entre {min} y {max} caracteres.",
