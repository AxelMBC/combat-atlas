...
Recreate the desktop hover "active" affordance for fight and fighter cards on touch devices, where there is no pointer hover, by activating whichever card is centered in the viewport as the user scrolls.
