# hero-fullscreen Specification

## Purpose

Let users watch the cinematic hero video in the browser's native fullscreen mode, matching the behavior of a normal YouTube video, including landscape orientation on mobile, while degrading gracefully on platforms that lack fullscreen or orientation APIs.
